...
public class ParallelKafkaSourceHealth extends BaseHealth {

    private final KafkaAdmin admin;
    private final ParallelKafkaSource<?, ?> source;
    private final ParallelKafkaConsumer<?, ?> client;
    private final Set<String> topics;
    private final Pattern pattern;
    private final Duration adminClientTimeout;
    private Metric metric;

    public ParallelKafkaSourceHealth(ParallelKafkaSource<?, ?> source, KafkaConnectorIncomingConfiguration config,
                                     ParallelKafkaConsumer<?, ?> client, Set<String> topics, Pattern pattern) {
